...
import achiever1 from "../img/robert.jpeg";
import achiever2 from "../img/banner.jpeg";
import achiever3 from "../img/batman.jpeg";
                ...
                <div className="achievers-grid">
                    <div className="achiever">
                        ...
                        <div className="achiever-details">
                            <h3>Tony Stark</h3>
                            <p className="role">Genius,billionare,playboy</p>
                    ...
                    <div className="achiever">
                        ...
                        <div className="achiever-details">
                            <h3>Bruce Banner</h3>
                            <p className="role">Strongest Avenger</p>
